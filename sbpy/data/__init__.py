...
class Conf():
    ...
    fieldnames_info = [
        ...
        {'description': 'Perihelion Distance',
         'fieldnames': ['perihelion', 'perihelion_dist'],
         'provenance': ['orbit', 'ephem', 'obs'],
         'dimension': 'length'},
        {'description': 'Time of perihelion passage in Julian days',
         'fieldnames': ['tJD_perihelion', 'timeJD_perihelion'],
         'provenance': ['orbit', 'ephem', 'obs'],
         'dimension': 'time'},
        {'description': 'Time of perihelion passage in calendar days',
         'fieldnames': ['tCD_perihelion', 'timeCD_perihelion'],
         'provenance': ['orbit', 'ephem', 'obs'],
         'dimension': 'time'},
        {'description': 'Orbital Period',
         'fieldnames': ['orb_period', 'orbital_period'],
         'provenance': ['orbit', 'ephem', 'obs'],
         'dimension': 'time'},
        {'description': 'Mean motion',
         'fieldnames': ['mean_motion'],
         'provenance': ['orbit', 'ephem', 'obs'],
         'dimension': 'angular velocity'},
        {'description': 'Aphelion Distance',
         'fieldnames': ['aphelion', 'aphelion_dist'],
         'provenance': ['orbit', 'ephem', 'obs'],
         'dimension': 'length'},
        ...
        {'description': 'Z heliocentric position vector',
         ...
         {'description': 'Photometric Slope Parameter',
          'fieldnames': ['photslope', 'phot_slope'],
          'provenance': ['ephem', 'obs'],
          'dimension': None},
